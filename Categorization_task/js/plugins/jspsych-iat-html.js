 ...
 **/
 ...
 jsPsych.plugins['iat-html'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    html_str += "<div style='position: absolute; height: 20%; width: 100%; font-size: 23px; margin-left: auto; margin-right: auto; top: 42%; left: 0; right: 0'><p id='jspsych-iat-stim' class='" + trial.category + "'>" + trial.stimulus + "</p></div>";

    html_str += "<div id='trial_left_align' style='position: absolute; top: 18%; left: 20%'>";

    if(trial.left_category_label.length == 1) {
      html_str += "<p>Press <span class='key'>" + trial.left_category_key + "</span> for words relating to:<br> " +
      "<span class ='"+ trial.label_category[0] +"'> "+ trial.left_category_label[0].bold() + "</span></p></div>";
    } else {
      html_str += "<p>Press <span class='key'>" + trial.left_category_key + "</span> for words relating to:<br> " +
      "<span class ='"+ trial.label_category[0] +"'> "+ trial.left_category_label[0].bold() + "</span><br>" +
    ...
    if(trial.right_category_label.length == 1) {
      html_str += "<p>Press <span class='key'>" + trial.right_category_key + "</span> for words relating to:<br> " +
      "<span class ='"+ trial.label_category[0] +"'> "+ trial.right_category_label[0].bold() + '</span></p></div>';
    } else {
      html_str += "<p>Press <span class='key'>" + trial.right_category_key + "</span> for words relating to:<br> " +
      "<span class ='"+ trial.label_category[0] +"'> "+ trial.right_category_label[0].bold() + "</span><br>" +
